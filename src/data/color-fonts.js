define(function () {
  return {
    ...
    browsers: [
      ...
      { name: "firefox", range: "36-",  support: "yes", note: "Only COLR/CPAL and OpenType-SVG." },
      { name: "opera",   range: "-",  support: "no" },
      { name: "safari",  range: "-8", support: "no" },
      { name: "safari",  range: "9-", support: "yes", note: "Only SBIX." },
    ...
    features: [
      {
        name: "SBIX",
        description: "Apple's implementation of color fonts. Uses embedded PNG images to represent the color glyphs.",
      ...
      {
        name: "CBDT/CBLC",
        description: "Google's CBDT/CBLC font format. Currently only supported on Android when installed as a system font; not available through @font-face. Uses embedded PNG images to represent the color glyphs.",
